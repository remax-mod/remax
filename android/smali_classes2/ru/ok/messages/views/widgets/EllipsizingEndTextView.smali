...
.method private getFullyVisibleLinesCount()I
    ...
    invoke-virtual {p0, v0}, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->l(Ljava/lang/CharSequence;)Landroid/text/StaticLayout;
...
.method public getMaxLines()I
    ...
    iget p0, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->z0:I

    return p0
.end method

.method public final l(Ljava/lang/CharSequence;)Landroid/text/StaticLayout;
    .locals 12
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v3, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->w0:Z

    if-eqz v3, :cond_6

    iget-boolean v3, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->D0:Z

    const-string v4, "\u2026"

    if-eqz v3, :cond_0

    iget-object v3, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->y0:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v3}, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->l(Ljava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    invoke-virtual {p0, v7}, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->l(Ljava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    :cond_2
    instance-of v3, v5, Landroid/text/SpannedString;
    ...
    invoke-virtual {v3, v0, v5, v4}, Landroid/text/SpannableStringBuilder;->replace(IILjava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;

    goto :goto_1

    :cond_3
    iget-object v3, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->C0:Ljava/util/regex/Pattern;
    ...
    iput-boolean v1, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->x0:Z
    ...
    :cond_5
    :goto_2
    iput-boolean v1, p0, Lru/ok/messages/views/widgets/EllipsizingEndTextView;->w0:Z
