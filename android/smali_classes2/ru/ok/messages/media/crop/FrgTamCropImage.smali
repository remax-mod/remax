...
# instance fields
.field public B1:Lone/me/image/crop/view/ImageCropView;
...
.method public final L0(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lnz3;
...
.method public final O0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    sget v0, Lxxb;->frg_tam_crop_image__iv_crop:I
    ...
    iput-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->B1:Lone/me/image/crop/view/ImageCropView;
    ...
    sget v0, Lxxb;->frg_tam_crop_image__rotate:I
    ...
    sget v0, Lxxb;->frg_tam_crop_image__flip:I
    ...
    sget v0, Lxxb;->frg_tam_crop_image__btn_clear:I
    ...
    iput-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->G1:Landroid/widget/TextView;

    sget v0, Lxxb;->frg_tam_crop_image__btn_done:I
    ...
    iput-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->E1:Landroid/widget/ImageButton;

    sget v0, Lxxb;->frg_tam_crop_image__btn_close:I
    ...
    iput-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->F1:Landroid/widget/ImageButton;
    ...
    invoke-static {v10, v0, p1}, Lhm9;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_0
    :try_start_0
    iget-object p2, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->B1:Lone/me/image/crop/view/ImageCropView;

    iget-object p2, p2, Lone/me/image/crop/view/ImageCropView;->a:Lwa6;

    invoke-virtual {p2}, Ld1f;->getMaxBitmapSize()I
    ...
    invoke-direct {v9, v0, p2}, Lqqd;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct/range {v3 .. v9}, Lzn0;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILqqd;)V
    ...
    iput-object p1, p2, Lt37;->H0:Lnz3;
    :try_end_0
    ...
    invoke-static {v10, p2, p1}, Lhm9;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, p1, p2}, La14;->N(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, v2}, Lc56;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {p2, p0, v1}, Lc56;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    invoke-static {p1, p2}, Lnd7;->h(Landroid/view/View;Lf6;)Lsd7;

    iget-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->G1:Landroid/widget/TextView;

    new-instance p2, Lc56;

    const/4 v0, 0x2

    invoke-direct {p2, p0, v0}, Lc56;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    invoke-static {p1, p2}, Lnd7;->h(Landroid/view/View;Lf6;)Lsd7;

    iget-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->F1:Landroid/widget/ImageButton;
    ...
    invoke-static {v2, p2}, Lhm9;->L(II)Landroid/graphics/drawable/RippleDrawable;
...
.method public final x0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p0, Lyyb;->frg_tam_crop_image:I
