...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "exception",
        "debugApiException",
        "(Lvk;Lfl;Lru/ok/android/api/core/ApiException;)V",
        "Ljava/io/IOException;",
        "debugIoException",
        "(Lvk;Lfl;Ljava/io/IOException;)V",
        "La4c;",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lz84;)V
...
.method public constructor <init>(La4c;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:La4c;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:La4c;
...
.method private final getParams(Lfl;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lfl;)Ljava/lang/String;
...
.method private final getRawParams(Lfl;)Ljava/lang/String;
    .locals 2
    ...
    invoke-direct {v1, v0}, Lp2b;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lp2b;->s()V

    invoke-interface {p1, v1}, Lfl;->writeParams(Lkb7;)V

    invoke-virtual {v1}, Lp2b;->q()V

    invoke-virtual {v1}, Lp2b;->flush()V
    :try_end_0
...
.method public debugApiException(Lvk;Lfl;Lru/ok/android/api/core/ApiException;)V
    ...
    invoke-interface {p0, p2, p1, p3}, La4c;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public debugApiRequest(Lvk;Lfl;Lwk;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:La4c;

    invoke-interface {p2}, Lfl;->getUri()Landroid/net/Uri;

    move-result-object p3

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lfl;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lvk;Lfl;Ldb7;)Ldb7;
    ...
    invoke-interface {p3}, Ldb7;->V()Ljava/lang/String;
    ...
    invoke-interface {p0, p3, p2}, La4c;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Leb7;->d(Ljava/lang/String;)Leb7;
