...
.field private animojiDataSupplier:Lbi;
...
.field private final experiments:Lyf1;
...
.field private groupCallMediaAdaptationConfig:Lr38;
...
.field private log:La4c;

.field private logConfiguration:Lb4c;
...
.field private p2pCallMediaAdaptationConfig:Lr38;
...
.field private final tracerLiteFacade:Lxye;
...
.method public constructor <init>(Lq2a;Landroid/content/Context;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Lq2a;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Lq2a;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-direct {v6, v0, v1}, Ldw3;-><init>(Ljava/time/Clock;I)V
    ...
    .line 3
    invoke-direct/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Lq2a;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V

    return-void
.end method

.method public constructor <init>(Lq2a;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V
    .locals 5
    ...
    .line 8
    sget-object v2, Lz3c;->a:Lz3c;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;

    .line 9
    sget-object v2, Lru/ok/android/externcalls/sdk/CallUtil;->LOG_CONFIGURATION:Lb4c;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lb4c;
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Ldnc;
    ...
    invoke-direct {v3}, Lyf1;-><init>()V

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    .line 34
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->locale:Ljava/util/Locale;

    .line 35
    sget-object v2, Lb46;->b:Lb46;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lbi;
    ...
    .line 48
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;
    ...
    .line 52
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lhc3;
    ...
    invoke-direct {p4, p0, v2}, Lcw3;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-direct {p3, p4}, Lru/ok/android/externcalls/sdk/factory/internal/RTCLogWrapper;-><init>(Lk56;)V

    invoke-static {p2, p3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->get(Landroid/content/Context;La4c;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    ...
    invoke-direct {v3, v2, v4}, Ldw3;-><init>(Ljava/time/Clock;I)V
    ...
    .line 59
    invoke-static {}, Lru/ok/android/externcalls/sdk/CallUtil;->createBitrates()Lxf1;

    move-result-object p3

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lxf1;
    ...
    invoke-direct {p3, p4}, Lru/ok/android/externcalls/sdk/api/OkApiService;-><init>(Lqpc;)V
    ...
    .line 61
    new-instance p3, Lxye;

    invoke-direct {p3, p2}, Lxye;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lxye;
    ...
    invoke-direct {p4, p0, p5}, Lcw3;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-virtual {p2, v0, p3, p1, p4}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lq2a;Lk56;)V

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactory;)La4c;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$0()La4c;
...
.method private getBaseBuilder()Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lq2a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lxye;

    invoke-direct {v2, v3, v1}, Lfze;-><init>(Lxye;La4c;)V

    move-object v1, v2

    :goto_0
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLog(La4c;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lb4c;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLogConfiguration(Lb4c;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lxf1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Lxf1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Ldnc;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Ldnc;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lbi;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setAnimojiDataSupplier(Lbi;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lr38;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lr38;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lr38;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lr38;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setExperiments(Lyf1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lyuc;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lyuc;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public static declared-synchronized init(Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams;)V
    ...
    .line 16
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams$PeerConnection;->getLogger()La4c;
    ...
    invoke-direct/range {v15 .. v23}, Lpsa;-><init>(ZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    .line 40
    invoke-direct/range {v19 .. v27}, Lpsa;-><init>(ZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    .line 42
    invoke-direct/range {v5 .. v18}, Lqsa;-><init>(ZZLjava/lang/String;Ljava/lang/String;Ljava/lang/Integer;ZZZZLpsa;ZZLjava/lang/String;)V
    ...
    .line 44
    invoke-direct {v2, v0, v4, v6, v5}, Lh7b;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams$PeerConnection;->getLibraryLoader()Lorg/webrtc/NativeLibraryLoader;

    move-result-object v0

    .line 46
    invoke-static {v3, v2, v0}, Lnsa;->D(Landroid/content/Context;Lh7b;Lorg/webrtc/NativeLibraryLoader;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static synthetic l(Lru/ok/android/externcalls/sdk/ConversationFactory;)La4c;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$1()La4c;
...
.method private static synthetic lambda$answer$5(Lnl;)Lnl;
    .locals 0
...
.method private static synthetic lambda$answer$6(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Lru/ok/android/externcalls/sdk/Conversation;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnPrepared()Lm56;
...
.method private static synthetic lambda$answer$7(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnError()Lm56;
...
.method private static synthetic lambda$call$2(Lnl;)Lnl;
    .locals 0
...
.method private static synthetic lambda$createConfRoom$18(Lnl;)Lnl;
    .locals 0
...
.method private static synthetic lambda$joinAnonByLink$13(Lnl;)Lnl;
    .locals 0
...
.method private static synthetic lambda$joinAnonByLink$14(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lql;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private static synthetic lambda$joinByLink$10(Lnl;)Lnl;
    .locals 0
...
.method private synthetic lambda$new$0()La4c;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;

    return-object p0
.end method

.method private synthetic lambda$new$1()La4c;
    .locals 0
...
.method public static synthetic o(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lql;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinAnonByLink$14(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;)Lql;
...
# virtual methods
.method public answer(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getCameraCapturerFactory()Lgy9;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lgy9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v1

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getFrameInterceptor()Luz1;

    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Luz1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Ldwe;

    move-result-object v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {v3}, Lq2a;->d()Lfc3;

    move-result-object v3

    iget-object v4, v3, Lfc3;->a:Ljava/lang/Object;

    check-cast v4, Lse3;

    new-instance v5, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v5, v4}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lse3;)V

    iput-object v5, v3, Lfc3;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Ldwe;

    move-result-object v4

    iput-object v4, v3, Lfc3;->b:Ljava/lang/Object;

    invoke-virtual {v3}, Lfc3;->g()Lq2a;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lq2a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenInfoProvider()Lrl;
    ...
    iget-object v4, v3, Lfc3;->Z:Ljava/lang/Object;

    check-cast v4, Lnl;

    invoke-static {v4}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$answer$5(Lnl;)Lnl;

    move-result-object v4

    iput-object v4, v3, Lfc3;->Z:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenInfoProvider()Lrl;

    move-result-object v4

    iput-object v4, v3, Lfc3;->Y:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;

    const-string v4, "Try to decode provided conversation params"

    invoke-interface {v3, v0, v4}, La4c;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p0, v0, v3}, La4c;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lbw3;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    new-instance v0, Lbw3;

    const/4 v3, 0x1

    invoke-direct {v0, p1, v3}, Lbw3;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    invoke-virtual {v1, v2, p0, v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Lrj3;Lrj3;)V

    return-object v1
.end method

.method public call(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Luz1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lgy9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Ldwe;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {v2}, Lq2a;->d()Lfc3;

    move-result-object v2

    iget-object v3, v2, Lfc3;->a:Ljava/lang/Object;

    check-cast v3, Lse3;

    new-instance v4, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v4, v3}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lse3;)V

    iput-object v4, v2, Lfc3;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Ldwe;

    move-result-object v3

    iput-object v3, v2, Lfc3;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lfc3;->g()Lq2a;

    move-result-object v2

    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lq2a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenInfoProvider()Lrl;

    move-result-object v2

    if-eqz v2, :cond_1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {p0}, Lq2a;->d()Lfc3;
    ...
    invoke-static {v2}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$call$2(Lnl;)Lnl;

    move-result-object v2

    iput-object v2, p0, Lfc3;->Z:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenInfoProvider()Lrl;

    move-result-object v2

    iput-object v2, p0, Lfc3;->Y:Ljava/lang/Object;

    invoke-virtual {p0}, Lfc3;->g()Lq2a;

    move-result-object p0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lq2a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v0, p1, v2}, Lwv3;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    new-instance v2, Lwv3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lwv3;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    invoke-virtual {p0, v1, v0, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Lrj3;Lrj3;)V
...
.method public clearApiAuthSession()V
    ...
    invoke-virtual {p0}, Lq2a;->b()Lr2a;

    move-result-object p0

    invoke-interface {p0}, Lr2a;->b()V

    return-void
.end method

.method public createConfRoom(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lgy9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenProvider()Ldwe;
    ...
    iget-object v2, v1, Lfc3;->a:Ljava/lang/Object;

    check-cast v2, Lse3;

    new-instance v3, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v3, v2}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lse3;)V

    iput-object v3, v1, Lfc3;->a:Ljava/lang/Object;

    invoke-virtual {v1}, Lfc3;->g()Lq2a;
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenInfoProvider()Lrl;
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$createConfRoom$18(Lnl;)Lnl;

    move-result-object v1

    iput-object v1, p0, Lfc3;->Z:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenInfoProvider()Lrl;

    move-result-object v1

    iput-object v1, p0, Lfc3;->Y:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->initStore(Ljava/util/Collection;)V
    ...
    invoke-direct {v5, p1, v0}, Lew3;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V

    new-instance v6, Lew3;

    const/4 v0, 0x1

    invoke-direct {v6, p1, v0}, Lew3;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V
    ...
    invoke-virtual/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;ZZLrj3;Lrj3;)V
...
.method public getAnimojiDataSupplier()Lbi;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lbi;
...
.method public hangup(Lji6;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 19
    invoke-virtual {p0, p1, p2, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->hangup(Lji6;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public hangup(Lji6;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    ...
    .line 5
    invoke-virtual {v0, v1, p2}, Lrk0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2, p1}, Lrk0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "anonymToken"

    .line 7
    invoke-virtual {v0, p1, p3}, Lrk0;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 8
    sget-object p1, Lod2;->b:Lob6;
    ...
    .line 9
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    .line 10
    invoke-virtual {p2}, Lq2a;->c()Lqpc;
    ...
    invoke-direct {p3, v0}, Lyv3;-><init>(I)V
    ...
    invoke-direct {v0, p1, p3}, Lglc;-><init>(Lfl;Lza7;)V

    .line 12
    invoke-virtual {p2, v0}, Lqpc;->a(Lyk;)Ldrd;

    move-result-object p1

    .line 13
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    iget-boolean p2, p2, Lyf1;->h:Z

    iget-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;

    .line 14
    invoke-static {p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Liqd;ZLa4c;)Liqd;
    ...
    invoke-direct {v0, p2, v1, p3}, Liq1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    .line 17
    invoke-virtual {p1, v0}, Liqd;->k(Lerd;)V

    .line 18
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lhc3;
...
.method public join(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Luz1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lgy9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v1, p1, v2}, Law3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V

    new-instance v2, Law3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Law3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V

    invoke-virtual {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Lrj3;Lrj3;)V

    return-object p0
.end method

.method public joinAnonByLink(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {v0}, Lq2a;->d()Lfc3;

    move-result-object v0

    iget-object v1, v0, Lfc3;->Y:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lfc3;->Z:Ljava/lang/Object;

    check-cast v1, Lnl;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinAnonByLink$13(Lnl;)Lnl;
    ...
    invoke-direct {v1, v2, p1}, Lv02;-><init>(ILjava/lang/Object;)V
    ...
    :cond_0
    iget-object v1, v0, Lfc3;->a:Ljava/lang/Object;

    check-cast v1, Lse3;

    new-instance v2, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v2, v1}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lse3;)V

    iput-object v2, v0, Lfc3;->a:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Luz1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {v0}, Lfc3;->g()Lq2a;

    move-result-object v0

    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lq2a;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lgy9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v0, p1, v1}, Lxv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    new-instance v1, Lxv3;

    const/4 v2, 0x1

    invoke-direct {v1, p1, v2}, Lxv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;->getToken()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, v0, v1, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Lrj3;Lrj3;Ljava/lang/String;)V

    return-object p0
.end method

.method public joinByLink(Lm56;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;->getTokenProvider()Ldwe;
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;->getTokenInfoProvider()Lrl;
    ...
    invoke-static {v2}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$joinByLink$10(Lnl;)Lnl;
    ...
    invoke-direct {v0, p1, v2}, Lzv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V

    new-instance v2, Lzv3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lzv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V

    invoke-virtual {p0, v0, v2, v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Lrj3;Lrj3;Ljava/lang/String;)V
...
.method public reset()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Lhc3;

    invoke-virtual {v0}, Lhc3;->d()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lq2a;

    invoke-virtual {v0}, Lq2a;->b()Lr2a;

    move-result-object v0

    invoke-interface {v0}, Lr2a;->b()V
...
.method public setAnimojiDataSupplier(Lbi;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Lbi;
...
.method public setApiRetriesEnabled(Z)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    iput-boolean p1, p0, Lyf1;->h:Z
...
.method public setBitrates(Lxf1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lxf1;
...
.method public setCameraFrameMaxDimension(I)V
    ...
    iput-object p1, p0, Lyf1;->e:Ljava/lang/Integer;
...
.method public setExceptionConsumer(Ly3c;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public setGroupCallMediaAdaptationConfig(Lr38;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lr38;
...
.method public setLogConfiguration(Lb4c;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lb4c;

    return-void
.end method

.method public setLogger(La4c;)V
    .locals 2

    if-nez p1, :cond_0

    sget-object p1, Lz3c;->a:Lz3c;
    ...
    sget-object v1, Lhl;->a:Lgl;

    invoke-interface {v0, v1}, Lr2a;->f(Lhl;)V
    ...
    invoke-direct {v1, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;-><init>(La4c;)V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lxye;

    invoke-direct {v0, v1, p1}, Lfze;-><init>(Lxye;La4c;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:La4c;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/log/GlobalRTCLogger;->setLog(La4c;)V
...
.method public setP2PCallMediaAdaptationConfig(Lr38;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lr38;

    return-void
.end method

.method public setRotationProvider(Ldnc;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Ldnc;
...
.method public setScreenCapturePermissionProvider(Lyuc;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lyuc;
...
.method public setStartCallByExternalIdEnabled(Z)V
    ...
    iput-boolean p1, p0, Lyf1;->j:Z

    return-void
.end method

.method public setTimeouts(Lzf1;)V
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    iput-object p1, p0, Lyf1;->f:Lzf1;
...
.method public setVideoDegradationForSoftwareCodec(ZLjava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lyf1;

    iput-boolean p1, v0, Lyf1;->b:Z
