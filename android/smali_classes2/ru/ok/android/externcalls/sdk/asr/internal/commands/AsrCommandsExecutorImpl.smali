...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onSuccess",
        "startRecord",
        "(Ljava/lang/String;Lzad;Lk56;Lm56;)V",
        "stopRecord",
        "(Lzad;Lk56;Lm56;)V",
        "Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;",
        "Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;",
...
.method public static synthetic a(Lk56;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->startRecord$lambda$0(Lk56;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Lk56;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->stopRecord$lambda$2(Lk56;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic c(Lm56;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->startRecord$lambda$1(Lm56;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lm56;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->stopRecord$lambda$3(Lm56;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final getActiveRoomId()Lzad;
    .locals 0
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lzad;
...
.method private static final startRecord$lambda$0(Lk56;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final startRecord$lambda$1(Lm56;Lorg/json/JSONObject;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/asr/exceptions/AsrException;-><init>(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Throwable;ILz84;)V

    invoke-interface {p0, v6}, Lm56;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    return-void
.end method

.method private static final stopRecord$lambda$2(Lk56;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final stopRecord$lambda$3(Lm56;Lorg/json/JSONObject;)V
    .locals 7
...
# virtual methods
.method public startRecord(Ljava/lang/String;Lzad;Lk56;Lm56;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getActiveRoomId()Lzad;

    move-result-object p2

    :cond_0
    invoke-direct {p0, p4}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lm56;)Lrod;
    ...
    invoke-virtual {v0, p2, p1}, Lka6;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {p0, v0, p3, p1, p2}, Lrod;->d(Luod;ZLqod;Lqod;)V
...
.method public stopRecord(Lzad;Lk56;Lm56;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lm56;)Lrod;
    ...
    invoke-virtual {v0, p1, v1}, Lka6;->b(ILjava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, v1, p2}, Lmt;-><init>(ILk56;)V

    new-instance p2, Lnt;

    invoke-direct {p2, v1, p3}, Lnt;-><init>(ILm56;)V
