...
.field public s0:Landroid/text/BoringLayout;
...
.method public synthetic constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Loh5;-><init>(Landroid/content/Context;)V

    .line 2
    invoke-direct {p0, p1, v0}, Lph5;-><init>(Landroid/content/Context;Loh5;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Loh5;)V
    .locals 12
    ...
    .line 4
    iput-object p1, p0, Lph5;->a:Landroid/content/Context;

    .line 5
    iput-object p2, p0, Lph5;->b:Loh5;
    ...
    iput-object p2, p0, Lph5;->o:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lph5;->X:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Lph5;->Z:Landroid/text/BoringLayout$Metrics;

    const/high16 v0, 0x41100000    # 9.0f

    .line 12
    iput v0, p0, Lph5;->t0:F
    ...
    invoke-direct {v3, v4, v5}, Lck4;-><init>(J)V
    ...
    .line 26
    invoke-static {v7, v8, p1}, Lck4;->d(JLandroid/util/DisplayMetrics;)F
    ...
    invoke-static {v0}, Lx53;->f0(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    .line 28
    :cond_0
    iget-wide v2, v0, Lck4;->a:J

    .line 29
    invoke-static {v2, v3, p1}, Lck4;->d(JLandroid/util/DisplayMetrics;)F
...
# virtual methods
.method public final a(Luf5;)V
    .locals 1

    iget-object v0, p0, Lph5;->c:Luf5;
    ...
    :cond_0
    iput-object p1, p0, Lph5;->c:Luf5;

    sget-object p1, Lqp4;->u0:Lpq9;

    iget-object v0, p0, Lph5;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Lph5;->onThemeChanged(Lfka;)V

    invoke-virtual {p0}, Landroid/graphics/drawable/Drawable;->getBounds()Landroid/graphics/Rect;

    move-result-object p1

    invoke-virtual {p0, p1}, Lph5;->onBoundsChange(Landroid/graphics/Rect;)V

    invoke-virtual {p0}, Lph5;->invalidateSelf()V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lph5;->o:Landroid/graphics/RectF;

    iget-object v2, p0, Lph5;->Y:Lje7;
    ...
    iget-object p0, p0, Lph5;->s0:Landroid/text/BoringLayout;
    ...
    invoke-static {v3, v4, v5, v0}, Lz7b;->f(FFFF)F
    ...
    invoke-static {v1, v4, v5, v3}, Lz7b;->f(FFFF)F
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v6, p0, Lph5;->X:Landroid/text/TextPaint;

    :try_start_0
    iget p1, p0, Lph5;->t0:F
    ...
    iget-object v11, p0, Lph5;->Z:Landroid/text/BoringLayout$Metrics;

    :try_start_1
    invoke-virtual {v6, v11}, Landroid/graphics/Paint;->getFontMetricsInt(Landroid/graphics/Paint$FontMetricsInt;)I

    invoke-interface {v0}, Luf5;->a()Ljava/lang/String;
    ...
    iput-object p1, p0, Lph5;->s0:Landroid/text/BoringLayout;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iput-object v1, p0, Lph5;->s0:Landroid/text/BoringLayout;
...
.method public final onThemeChanged(Lfka;)V
    ...
    invoke-interface {v0}, Luf5;->b()Lmf5;

    move-result-object v3

    iget v3, v3, Lmf5;->b:I

    invoke-interface {v2, v3}, Lnr2;->c(I)I
    ...
    invoke-interface {v3, v4}, Lnr2;->c(I)I

    move-result v3

    iget-object v4, p0, Lph5;->b:Loh5;

    iget-object v5, v4, Loh5;->a:Lje7;
    ...
    iget-object v1, p0, Lph5;->X:Landroid/text/TextPaint;
    ...
    invoke-interface {p1, v0}, Lnr2;->c(I)I
