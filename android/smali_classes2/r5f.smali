...
# direct methods
.method public constructor <init>(Lm29;Lone/me/sdk/lists/widgets/EndlessRecyclerView2;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lr5f;->a:Lm29;

    iput-object p2, p0, Lr5f;->b:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, Lr5f;->o:Lgaa;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lr5f;->X:Landroid/graphics/Rect;

    sget-object p1, Ldu4;->b:Ldu4;

    iput-object p1, p0, Lr5f;->Z:Ldu4;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lzdc;)V
    ...
    iget-object v0, p0, Lr5f;->o:Lgaa;

    if-ltz p4, :cond_5

    iget-object v1, p0, Lr5f;->a:Lm29;

    iget-object v2, v1, Lhl7;->o:Liv;
    ...
    :cond_0
    invoke-virtual {v1, v2, v3}, Lm29;->K(J)I

    move-result v4

    invoke-virtual {v1, v4}, Lm29;->L(I)Lone/me/messages/list/loader/MessageModel;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Lr5f;->i()Landroid/view/View;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v0, p1, p2, p3}, Lgaa;->E(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    invoke-virtual {v0, v1, v2}, Lm29;->K(J)I
    ...
    :cond_4
    invoke-virtual {v0, v5}, Lm29;->L(I)Lone/me/messages/list/loader/MessageModel;

    move-result-object v6

    if-eqz v6, :cond_8

    iget-wide v7, p0, Lr5f;->c:J
    ...
    iget-object v7, p0, Lr5f;->o:Lgaa;

    iget-object v8, p0, Lr5f;->X:Landroid/graphics/Rect;
    ...
    iget-object v12, p0, Lr5f;->b:Landroidx/recyclerview/widget/RecyclerView;

    move-object v11, v6

    invoke-static/range {v7 .. v12}, Lc54;->L(IIIILandroid/view/View;Landroid/view/View;)V
...
.method public final i()Landroid/view/View;
    ...
    iget-object v0, p0, Lr5f;->Y:Landroid/widget/FrameLayout;
    ...
    :cond_0
    iget-object v0, p0, Lr5f;->b:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v6, v2}, Lpq9;->j(Landroid/view/View;)Lfka;

    move-result-object v7

    invoke-interface {v7}, Lfka;->a()Lnr2;

    move-result-object v7

    invoke-interface {v7}, Lnr2;->s()Lv83;

    move-result-object v7

    iget-object v7, v7, Lv83;->b:Lm73;

    iget-object v7, v7, Lm73;->w:[I
    ...
    sget-object v4, Los2;->f:Lkqe;

    iget-object v5, p0, Lr5f;->Z:Ldu4;

    invoke-virtual {v4, v3, v5}, Lkqe;->b(Landroid/widget/TextView;Ldu4;)V
    ...
    iput-object v2, p0, Lr5f;->Y:Landroid/widget/FrameLayout;
...
.method public final onThemeChanged(Lfka;)V
    ...
    iget-object p0, p0, Lr5f;->Y:Landroid/widget/FrameLayout;
