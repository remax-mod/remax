...
.method public constructor <init>(Landroid/content/Context;Ltg;[F)V
    ...
    iput-object p2, p0, Lmk9;->o:Ltg;

    iput-object p3, p0, Lmk9;->X:[F

    sget p1, Lyyb;->view_auto_play_video_player:I
...
.method public final a(II)V
    ...
    iget-object v0, p0, Lmk9;->Y:Lru/ok/messages/video/widgets/VideoView;

    invoke-virtual {v0}, Lru/ok/messages/video/widgets/VideoView;->d()V

    iget-object p0, p0, Lmk9;->s0:Lru/ok/messages/views/widgets/VideoThumbnailView;
...
.method public final b(Lslf;)V
    ...
    iget-object p0, p0, Lmk9;->Y:Lru/ok/messages/video/widgets/VideoView;
...
.method public final c()V
    ...
    iget-object v1, p0, Lmk9;->v0:Landroid/graphics/drawable/LayerDrawable;
    ...
    iget-object v1, p0, Lmk9;->t0:Landroid/widget/ImageButton;

    sget-object v3, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {v1, v2, v3}, Landroid/widget/ImageView;->setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V

    iget-object p0, p0, Lmk9;->t0:Landroid/widget/ImageButton;
    ...
    invoke-static {v0, v3}, Lote;->b0(IF)I
    ...
    invoke-static {v1, v0, v2}, Lhm9;->g0(Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;)Landroid/graphics/drawable/StateListDrawable;
...
.method public final d(Lhkf;)V
    ...
    sget v0, Lxxb;->view_auto_play_video_player__v_video:I

    invoke-virtual {v1, v0}, Le2f;->p(I)V

    sget v0, Lxxb;->view_auto_play_video_player__iv_thumbnail:I
    ...
    :goto_0
    iget-object v0, p0, Lmk9;->u0:Landroid/widget/ImageView;

    iget-boolean v1, p1, Lhkf;->c:Z

    invoke-static {v0, v1}, Lmk9;->A(Landroid/view/View;Z)V

    iget-boolean v0, p1, Lhkf;->g:Z

    const/16 v1, 0x8

    if-eqz v0, :cond_1

    iget-object v0, p0, Lmk9;->Z:Lru/ok/messages/video/widgets/VideoPlayerSeekBar;
    ...
    invoke-static {v0, v2}, Lmk9;->A(Landroid/view/View;Z)V

    iget-object v0, p0, Lmk9;->Z:Lru/ok/messages/video/widgets/VideoPlayerSeekBar;

    iget-wide v2, p1, Lhkf;->j:J

    long-to-int v2, v2

    invoke-virtual {v0, v2}, Landroid/widget/ProgressBar;->setMax(I)V

    iget-wide v2, p1, Lhkf;->k:J
    ...
    iget-boolean v2, p1, Lhkf;->b:Z

    invoke-static {v0, v2}, Lmk9;->A(Landroid/view/View;Z)V

    iget-boolean v0, p1, Lhkf;->r:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lmk9;->t0:Landroid/widget/ImageButton;
...
.method public final m()V
    ...
    sget v1, Lxxb;->view_auto_play_video_player__v_video:I
    ...
    iput-object v0, p0, Lmk9;->Y:Lru/ok/messages/video/widgets/VideoView;

    iget-object v0, p0, Lv2;->c:Ljava/lang/Object;

    check-cast v0, Landroid/view/View;

    sget v1, Lxxb;->view_auto_play_video_player__sb_seek:I
    ...
    iput-object v0, p0, Lmk9;->Z:Lru/ok/messages/video/widgets/VideoPlayerSeekBar;
    ...
    iput-object v0, p0, Lmk9;->v0:Landroid/graphics/drawable/LayerDrawable;

    iget-object v0, p0, Lv2;->c:Ljava/lang/Object;

    check-cast v0, Landroid/view/View;

    sget v1, Lxxb;->view_auto_play_video_player__iv_thumbnail:I
    ...
    iput-object v0, p0, Lmk9;->s0:Lru/ok/messages/views/widgets/VideoThumbnailView;

    iget-object v0, p0, Lv2;->c:Ljava/lang/Object;

    check-cast v0, Landroid/view/View;

    sget v1, Lxxb;->view_auto_play_video_player__ib_sound:I
    ...
    iput-object v0, p0, Lmk9;->t0:Landroid/widget/ImageButton;
    ...
    sget v1, Lxxb;->view_auto_play_video_player__progress:I
    ...
    iput-object v0, p0, Lmk9;->u0:Landroid/widget/ImageView;
    ...
    invoke-direct {v1, v3, v2}, Lr20;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v1, p0, v2}, Llk9;-><init>(Lmk9;I)V

    invoke-static {v0, v1}, Lnd7;->h(Landroid/view/View;Lf6;)Lsd7;

    iget-object v0, p0, Lmk9;->s0:Lru/ok/messages/views/widgets/VideoThumbnailView;
