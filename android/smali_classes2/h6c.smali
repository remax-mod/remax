...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lh6c;->a:Ljava/lang/String;
...
.method private final getLotties()Lc6d;
    .locals 2
...
.method public final a(JLone/me/rlottie/RLottieDrawable;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0}, Lh6c;->getLotties()Lc6d;
    ...
    invoke-direct {v1, p1, p2, v2}, Ljh2;-><init>(JI)V
    ...
    invoke-direct {v1, v0}, Lpk5;-><init>(Lqk5;)V
    ...
    iget-object v2, p0, Lh6c;->a:Ljava/lang/String;
    ...
    new-instance v9, Lone/me/rlottie/RLottieImageView;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v9, v3}, Lone/me/rlottie/RLottieImageView;-><init>(Landroid/content/Context;)V

    invoke-static {v9, p3}, Lone/me/rlottie/RLottieImageViewUtils;->setLottieDrawable(Lone/me/rlottie/RLottieImageView;Lone/me/rlottie/RLottieDrawable;)Z

    invoke-virtual {v9}, Lone/me/rlottie/RLottieImageView;->playAnimation()V

    sget v3, Lwxb;->tag_reaction_effects_view:I

    invoke-static {p1, p2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object p1

    invoke-static {v3, v9, p1}, Ltpa;->J(ILandroid/view/View;Ljava/lang/Object;)V
    ...
    invoke-static {v0, p4}, Lh6c;->c(ILandroid/graphics/Rect;)F

    move-result p1

    invoke-virtual {v9, p1}, Landroid/view/View;->setX(F)V
    ...
    invoke-virtual {v9, p1}, Landroid/view/View;->setY(F)V

    invoke-virtual {p0, v9}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    new-instance v7, Lf6c;

    invoke-direct {v7, p0, v9}, Lf6c;-><init>(Lh6c;Lone/me/rlottie/RLottieImageView;)V
    ...
    invoke-direct {v8, p0, v9}, Lg6c;-><init>(Lh6c;Lone/me/rlottie/RLottieImageView;)V
    ...
    invoke-direct/range {v3 .. v8}, Le6c;-><init>(Lone/me/rlottie/RLottieImageView;Lh6c;Lone/me/rlottie/RLottieDrawable;Lf6c;Lg6c;)V

    invoke-virtual {v9, p1}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V
...
.method public final d(JLandroid/graphics/Rect;)V
    ...
    invoke-static {v2, v3}, Ltpa;->v(Landroid/view/View;I)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lh6c;->a:Ljava/lang/String;
    ...
    invoke-static {p1, p3}, Lh6c;->c(ILandroid/graphics/Rect;)F
