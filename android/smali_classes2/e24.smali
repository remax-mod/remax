...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;La4c;)V
    .locals 1
    ...
    iput-object v0, p0, Le24;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Le24;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Le24;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Le24;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Le24;->b:La4c;

    new-instance p2, Limc;

    const/16 v0, 0xe

    invoke-direct {p2, p0, v0, p1}, Limc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final a(Luoc;)V
    ...
    iget-object p0, p0, Le24;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object p0, p0, Le24;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    const-string v1, "rtc.datachannel.listen.send"

    iget-object v3, p0, Le24;->b:La4c;

    const-string v4, "DataChannelRtcTransport"

    invoke-interface {v3, v4, v1, v2}, La4c;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
