...
# instance fields
.field public X:Lorg/webrtc/VideoCodecInfo;
...
.field public final c:Lmra;

.field public final o:La4c;


# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZLa4c;)V
    .locals 2
    ...
    iput-object v0, p0, Lkra;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lkra;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lkra;->a:Lorg/webrtc/HardwareVideoEncoderFactory;

    if-eqz p2, :cond_0

    new-instance p1, Lmra;

    invoke-direct {p1, p0, p3}, Lmra;-><init>(Lkra;La4c;)V
    ...
    :goto_0
    iput-object p1, p0, Lkra;->c:Lmra;

    iput-object p3, p0, Lkra;->o:La4c;
...
.method public final createEncoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoEncoder;
    ...
    :goto_0
    iget-object v1, p0, Lkra;->a:Lorg/webrtc/HardwareVideoEncoderFactory;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lkra;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
    ...
    iget-object v3, p0, Lkra;->o:La4c;

    const-string v4, "PatchedVideoEncoderFactory"

    invoke-interface {v3, v4, v2}, La4c;->log(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lkra;->X:Lorg/webrtc/VideoCodecInfo;

    iget-object p0, p0, Lkra;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-direct {v2, p1, v3}, Lfsa;-><init>(Lnsa;I)V

    new-instance v3, Ladg;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v2, v4}, Ladg;-><init>(Lnsa;Lrj3;I)V

    const-string v2, "onNewCodecIsCreating"

    invoke-virtual {p1, v2, v3}, Lnsa;->i(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object p0, p0, Lkra;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
...
.method public final p(Lo38;)V
    ...
    invoke-virtual {p0, p1}, Lmra;->p(Lo38;)V
