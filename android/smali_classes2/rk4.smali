...
.method public final a(JLjava/lang/Long;Ljava/lang/Long;)V
    ...
    invoke-virtual {p4, v4, v5}, Lp82;->z(J)Le52;
    ...
    invoke-virtual {p3, v4, v5}, Lp82;->F(J)Le52;
    ...
    :cond_2
    iget-object p4, p3, Le52;->b:Lk92;

    iget-object p4, p4, Lk92;->f0:Luaa;

    if-nez p4, :cond_3

    const-string p0, "draft is null, ignore"

    invoke-static {v1, p0, v0}, Lhm9;->G(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_3
    invoke-virtual {p4}, Luaa;->b()Ljava/lang/Long;
    ...
    iget-wide p1, p3, Le52;->a:J

    invoke-virtual {p0, p1, p2}, Lp82;->p(J)V
