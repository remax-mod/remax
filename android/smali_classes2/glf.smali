...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lglf;->v0:Landroid/graphics/Typeface;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lglf;->getIntrinsicWidth()I

    move-result v1

    iget-object v2, p0, Lglf;->Y:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, p0, Lglf;->Z:Landroid/graphics/Paint;

    iget-object v4, p0, Lglf;->Y:Ljava/lang/String;
    ...
    :goto_1
    invoke-super {p0}, Lg06;->getIntrinsicWidth()I
    ...
    invoke-virtual {p0}, Lg06;->getIntrinsicHeight()I

    move-result v2

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v0, p0, Lglf;->Y:Ljava/lang/String;
    ...
    iget-object v1, p0, Lglf;->u0:Landroid/graphics/Path;
    ...
    :cond_3
    iget-object v1, p0, Lg06;->a:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lglf;->t0:Landroid/graphics/RectF;

    iget-object v1, p0, Lglf;->X:Lbk4;

    iget v2, v1, Lbk4;->b:I

    int-to-float v2, v2

    iget-object v3, p0, Lglf;->s0:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lglf;->Z:Landroid/graphics/Paint;
...
.method public final getIntrinsicWidth()I
    ...
    iget-object v1, p0, Lglf;->Y:Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lglf;->Z:Landroid/graphics/Paint;

    iget-object v3, p0, Lglf;->Y:Ljava/lang/String;
