...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lp5f;->f(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;

    move-result-object p2

    const/4 v0, 0x1

    invoke-direct {p0, p2, v0}, Lqk4;-><init>(Ljava/io/File;I)V

    iput-object p1, p0, Lp5f;->d:Landroid/content/Context;
...
.method public final d(I)V
    ...
    iget-object v1, p0, Lqk4;->a:Ljava/io/File;
    ...
    invoke-static {v1, v7}, Lmhe;->d(Ljava/io/File;Ljava/io/File;)Lrh5;
    ...
    :cond_5
    :goto_2
    invoke-virtual {p0, v7, p1}, Lp5f;->h(Lrh5;I)Z
    ...
    invoke-virtual {v6}, Lrh5;->close()V
...
.method public e()[B
    ...
    invoke-virtual {p0, v1}, Lp5f;->g(Z)Lcom/facebook/soloader/e;

    move-result-object p0

    :try_start_0
    invoke-virtual {p0}, Lcom/facebook/soloader/e;->m()[Ldle;
    ...
    iget-object v5, v4, Ldle;->b:Ljava/lang/Object;
...
.method public final h(Lrh5;I)Z
    .locals 15
    ...
    invoke-direct {v10, v0, v9}, Ljava/io/RandomAccessFile;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v10, v2, v9}, Ljava/io/RandomAccessFile;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    :goto_a
    invoke-static {v2, v6, v0}, Lp5f;->i(Ljava/io/File;BZ)V

    new-instance v10, Ldm9;

    const/4 v11, 0x1

    invoke-direct {v10, v11}, Ldm9;-><init>(I)V
    ...
    invoke-static {v13}, Lmhe;->b(Ljava/io/File;)V
    ...
    :cond_7
    invoke-virtual {p0, v7}, Lp5f;->g(Z)Lcom/facebook/soloader/e;

    move-result-object v7

    :try_start_b
    invoke-virtual {v7, v3}, Lcom/facebook/soloader/e;->n(Ljava/io/File;)V
    :try_end_b
    .catchall {:try_start_b .. :try_end_b} :catchall_6

    invoke-virtual {v7}, Lcom/facebook/soloader/e;->close()V
    ...
    invoke-direct {v4, p0, v0, v2, v7}, Lo5f;-><init>(Lp5f;ZLjava/io/File;Lrh5;)V
