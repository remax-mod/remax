...
.method public constructor <init>(Lje7;Lje7;Lje7;)V
    ...
    iput-object p3, p0, Lfra;->a:Lje7;

    iput-object p1, p0, Lfra;->b:Lje7;

    iput-object p2, p0, Lfra;->c:Lje7;
    ...
    iput-object p1, p0, Lfra;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lfra;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lfra;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lip1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lip1;->t0:Lhaf;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lip1;->u0:Z

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lfra;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    new-instance p0, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;->setScalingType(Lorg/webrtc/RendererCommon$ScalingType;Lorg/webrtc/RendererCommon$ScalingType;)V
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lfra;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    iget-object v3, v1, Lip1;->v0:Lllf;

    if-eqz v3, :cond_0

    const/4 v4, 0x1

    iget-boolean v3, v3, Lllf;->c:Z

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lip1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lfra;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-interface {v0}, Lig1;->s()Lllf;

    move-result-object v0

    iget-object v0, v0, Lllf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lfra;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lfra;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Lcra;->c()Lfqa;

    move-result-object p2

    iget-object p2, p2, Lfqa;->a:Lig1;

    invoke-interface {p2}, Lig1;->s()Lllf;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lfra;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Loe1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Loe1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
