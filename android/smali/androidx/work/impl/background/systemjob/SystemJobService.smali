...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lbdb;

    return-void
.end method

.method public static a(Landroid/app/job/JobParameters;)Ll7g;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Ll7g;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final b(Ll7g;Z)V
    ...
    iget-object v3, p1, Ll7g;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lbdb;

    invoke-virtual {v0, p1}, Lbdb;->j(Ll7g;)Lyzd;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;
    ...
    invoke-virtual {p0, v0, v1}, La14;->R(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->a(Landroid/app/job/JobParameters;)Ll7g;
    ...
    invoke-virtual {p0, p1, v0}, La14;->q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, La14;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, La14;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lgie;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    iput-object v1, v0, Lglc;->c:Ljava/lang/Object;

    :cond_3
    invoke-static {p1}, Lgie;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    iput-object v1, v0, Lglc;->b:Ljava/lang/Object;

    :cond_4
    invoke-static {p1}, Lhie;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    move-result-object p1

    iput-object p1, v0, Lglc;->o:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lbdb;

    invoke-virtual {p0, v2}, Lbdb;->o(Ll7g;)Lyzd;

    move-result-object p0

    invoke-virtual {p1, p0, v0}, Ls7g;->h(Lyzd;Lglc;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v1}, La14;->q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lbdb;

    invoke-virtual {v2, p1}, Lbdb;->j(Ll7g;)Lyzd;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;

    iget-object v4, v3, Ls7g;->d:Lwne;

    new-instance v5, Lk8e;

    invoke-direct {v5, v3, v2, v0}, Lk8e;-><init>(Ls7g;Lyzd;Z)V

    invoke-interface {v4, v5}, Lwne;->l(Ljava/lang/Runnable;)V

    :cond_2
    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Ls7g;

    iget-object p0, p0, Ls7g;->f:Ly9b;

    iget-object p1, p1, Ll7g;->a:Ljava/lang/String;
    ...
    :try_start_1
    iget-object p0, p0, Ly9b;->u0:Ljava/util/HashSet;
