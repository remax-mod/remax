...
.method public final onGlobalLayout()V
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->S0:Ljava/util/HashSet;
    ...
    invoke-direct {v4, v3, v5}, Lcoa;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V
    ...
    iget v3, v1, Landroidx/mediarouter/app/d;->t1:I

    int-to-long v9, v3

    iput-wide v9, v4, Lcoa;->e:J

    iget-object v3, v1, Landroidx/mediarouter/app/d;->u1:Landroid/view/animation/Interpolator;

    iput-object v3, v4, Lcoa;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v9, v3, v5}, Lcoa;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    iput v7, v9, Lcoa;->g:I

    iget v3, v1, Landroidx/mediarouter/app/d;->r1:I

    int-to-long v10, v3

    iput-wide v10, v9, Lcoa;->e:J

    iget-object v3, v1, Landroidx/mediarouter/app/d;->u1:Landroid/view/animation/Interpolator;

    iput-object v3, v9, Lcoa;->d:Landroid/view/animation/Interpolator;

    new-instance v3, Lh7b;

    const/16 v5, 0x18

    invoke-direct {v3, v1, v5, v4}, Lh7b;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v3, v9, Lcoa;->m:Lh7b;
    ...
    :goto_4
    iget-object v3, v1, Landroidx/mediarouter/app/d;->O0:Landroidx/mediarouter/app/OverlayListView;
