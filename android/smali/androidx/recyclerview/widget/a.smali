...
.method public constructor <init>()V
    ...
    invoke-direct {v2, v0}, Ll7b;-><init>(Lhmf;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/a;->c:Ll7b;

    new-instance v0, Ll7b;

    invoke-direct {v0, v1}, Ll7b;-><init>(Lhmf;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/a;->d:Ll7b;
...
.method public static N(Landroid/content/Context;Landroid/util/AttributeSet;II)Lodc;
    .locals 2
    ...
    sget-object v1, Lu2c;->RecyclerView:[I

    invoke-virtual {p0, p1, v1, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p0

    sget p1, Lu2c;->RecyclerView_android_orientation:I
    ...
    sget p1, Lu2c;->RecyclerView_spanCount:I
    ...
    sget p1, Lu2c;->RecyclerView_reverseLayout:I
    ...
    iput-boolean p1, v0, Lodc;->c:Z

    sget p1, Lu2c;->RecyclerView_stackFromEnd:I

    invoke-virtual {p0, p1, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v0, Lodc;->d:Z
...
.method public final A0(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/recyclerview/widget/a;->B0(II)V
...
.method public final D0(II)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroidx/recyclerview/widget/a;->C0(Landroid/graphics/Rect;II)V
...
.method public final E0(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;
    ...
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->t0:Ll0f;

    iput-object v0, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;
...
.method final F0(Landroid/view/View;IILpdc;)Z
    .locals 1
...
.method public final H0(Landroid/view/View;IILpdc;)Z
    .locals 1
...
.method public abstract I0(Landroidx/recyclerview/widget/RecyclerView;I)V
.end method
...
.method public final J0(Lyh7;)V
    .locals 3

    iget-object v0, p0, Landroidx/recyclerview/widget/a;->e:Lyh7;

    if-eqz v0, :cond_0

    if-eq p1, v0, :cond_0

    iget-boolean v1, v0, Lyh7;->e:Z
    ...
    :cond_0
    iput-object p1, p0, Landroidx/recyclerview/widget/a;->e:Lyh7;

    iget-object v0, p0, Landroidx/recyclerview/widget/a;->b:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->p1:Lcec;

    iget-object v2, v1, Lcec;->Z:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v2, v1}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v1, v1, Lcec;->c:Landroid/widget/OverScroller;

    invoke-virtual {v1}, Landroid/widget/OverScroller;->abortAnimation()V

    iput-object v0, p1, Lyh7;->b:Landroidx/recyclerview/widget/RecyclerView;

    iput-object p0, p1, Lyh7;->c:Landroidx/recyclerview/widget/a;
    ...
    iput-boolean v1, p1, Lyh7;->e:Z

    iput-boolean v1, p1, Lyh7;->d:Z
    ...
    iput-object p0, p1, Lyh7;->f:Landroid/view/View;

    iget-object p0, p1, Lyh7;->b:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final P(Landroid/graphics/Rect;Landroid/view/View;)V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RecyclerView;->z0:Landroid/graphics/RectF;
...
.method public S(Landroid/view/View;IIII)V
    ...
    iget-object v0, p0, Lpdc;->b:Landroid/graphics/Rect;
...
.method public Z(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->c:Lvdc;
...
.method public a0(Lvdc;Lzdc;Ll4;)V
    .locals 3
    ...
    invoke-virtual {p3, v0}, Ll4;->a(I)V

    invoke-virtual {p3, v2}, Ll4;->j(Z)V
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/a;->O(Lvdc;Lzdc;)I

    move-result v0

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/a;->y(Lvdc;Lzdc;)I

    move-result p0

    const/4 p1, 0x0

    invoke-static {v0, p0, p1}, Lj4;->a(III)Lj4;
    ...
    iget-object p1, p3, Ll4;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final b(ILandroid/view/View;Z)V
    ...
    iget-object p3, p3, Landroidx/recyclerview/widget/RecyclerView;->u0:Ldjb;

    invoke-virtual {p3, v0}, Ldjb;->o(Ldec;)V
    ...
    iget-object p3, p3, Ldjb;->b:Ljava/lang/Object;

    check-cast p3, Lqpd;

    invoke-virtual {p3, v0}, Lqpd;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p3, v0, v2}, Lqpd;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;

    iget-object v4, v2, Ll0f;->o:Ljava/lang/Object;

    check-cast v4, Lsy4;

    iget-object v4, v4, Lsy4;->b:Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v2, v4}, Lg03;->Q(I)I
    ...
    iget-object p1, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;

    invoke-virtual {p1}, Ll0f;->z()I
    ...
    invoke-virtual {v2, v4}, Ll0f;->r(I)V
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->u0:Ldjb;

    iget-object v5, v5, Ldjb;->b:Ljava/lang/Object;

    check-cast v5, Lqpd;

    invoke-virtual {v5, v4}, Lqpd;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v4, v6}, Lqpd;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->u0:Ldjb;

    invoke-virtual {v1, v4}, Ldjb;->o(Ldec;)V

    :goto_4
    iget-object p0, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;

    invoke-virtual {v4}, Ldec;->p()Z

    move-result v1

    invoke-virtual {p0, p2, p1, v2, v1}, Ll0f;->g(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-static {p0, p3}, Lms2;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, p2, v3}, Ll0f;->a(ILandroid/view/View;Z)V

    iput-boolean v1, p3, Lpdc;->c:Z

    iget-object p0, p0, Landroidx/recyclerview/widget/a;->e:Lyh7;

    if-eqz p0, :cond_e

    iget-boolean p1, p0, Lyh7;->e:Z

    if-eqz p1, :cond_e

    iget-object p1, p0, Lyh7;->b:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p2, p0, Lyh7;->f:Landroid/view/View;
    ...
    iget-object v1, v0, Ldec;->y0:Lvdc;

    invoke-virtual {v1, v0}, Lvdc;->k(Ldec;)V
    ...
    invoke-virtual {p0, p2, p1, v1, v3}, Ll0f;->g(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V

    :cond_e
    :goto_7
    iget-boolean p0, p3, Lpdc;->o:Z
    ...
    iget-object p0, p3, Lpdc;->a:Ldec;

    invoke-static {p0}, Ljava/util/Objects;->toString(Ljava/lang/Object;)Ljava/lang/String;

    :cond_f
    iget-object p0, v0, Ldec;->a:Landroid/view/View;

    invoke-virtual {p0}, Landroid/view/View;->invalidate()V

    iput-boolean v3, p3, Lpdc;->o:Z

    :cond_10
    return-void
.end method

.method public b0(Lvdc;Lzdc;Landroid/view/View;Ll4;)V
    .locals 0
...
.method public final c0(Landroid/view/View;Ll4;)V
    .locals 2
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;

    iget-object v1, v1, Ll0f;->Y:Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->s1:Lzdc;

    invoke-virtual {p0, v1, v0, p1, p2}, Landroidx/recyclerview/widget/a;->b0(Lvdc;Lzdc;Landroid/view/View;Ll4;)V
...
.method public final d(Landroid/graphics/Rect;Landroid/view/View;)V
    ...
    :cond_0
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/RecyclerView;->W(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public j(ILb23;)V
    .locals 0

    return-void
.end method

.method public abstract j0(Lvdc;Lzdc;)V
.end method

.method public abstract k(Lzdc;)I
.end method

.method public abstract k0(Lzdc;)V
.end method

.method public abstract l(Lzdc;)I
.end method
...
.method public abstract m(Lzdc;)I
.end method
...
.method public abstract n(Lzdc;)I
.end method
...
.method public abstract o(Lzdc;)I
.end method

.method public o0(Lvdc;Lzdc;ILandroid/os/Bundle;)Z
    .locals 2
...
.method public abstract p(Lzdc;)I
.end method
...
.method public final q(Lvdc;)V
    ...
    invoke-static {v1}, Landroidx/recyclerview/widget/RecyclerView;->U(Landroid/view/View;)Ldec;
    ...
    invoke-virtual {v2}, Ldec;->toString()Ljava/lang/String;

    goto :goto_1

    :cond_0
    invoke-virtual {v2}, Ldec;->n()Z
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->A0:Lhdc;
    ...
    invoke-virtual {v1, v0}, Ll0f;->R(I)V

    :cond_1
    invoke-virtual {p1, v2}, Lvdc;->h(Ldec;)V
    ...
    iget-object v3, p0, Landroidx/recyclerview/widget/a;->a:Ll0f;

    invoke-virtual {v3, v0}, Ll0f;->r(I)V

    invoke-virtual {p1, v1}, Lvdc;->i(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/recyclerview/widget/a;->b:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->u0:Ldjb;

    invoke-virtual {v1, v2}, Ldjb;->o(Ldec;)V
...
.method public r(I)Landroid/view/View;
    ...
    iget-object v4, v4, Landroidx/recyclerview/widget/RecyclerView;->s1:Lzdc;

    iget-boolean v4, v4, Lzdc;->h:Z
...
.method public final r0(Lvdc;)V
    ...
    invoke-virtual {v1}, Ldec;->w()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p0, v0, p1}, Landroidx/recyclerview/widget/a;->u0(ILvdc;)V
...
.method public abstract s()Lpdc;
.end method

.method public final s0(Lvdc;)V
    .locals 6

    iget-object v0, p1, Lvdc;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, p1, Lvdc;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v4}, Ldec;->v(Z)V

    invoke-virtual {v3}, Ldec;->r()Z
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->a1:Lmdc;

    if-eqz v5, :cond_2

    invoke-virtual {v5, v3}, Lmdc;->d(Ldec;)V

    :cond_2
    const/4 v5, 0x1

    invoke-virtual {v3, v5}, Ldec;->v(Z)V
    ...
    iget-object p1, p1, Lvdc;->b:Ljava/util/ArrayList;
...
.method public final t0(Landroid/view/View;Lvdc;)V
    .locals 5
    ...
    :cond_0
    :try_start_1
    iget-object v4, p0, Ll0f;->X:Ljava/lang/Object;

    check-cast v4, Lg03;

    invoke-virtual {v4, v2}, Lg03;->Z(I)Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {p0, p1}, Ll0f;->X(Landroid/view/View;)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {v0, v2}, Lsy4;->M(I)V
    :try_end_1
    ...
    :goto_2
    invoke-virtual {p2, p1}, Lvdc;->g(Landroid/view/View;)V
...
.method public u(Landroid/view/ViewGroup$LayoutParams;)Lpdc;
    ...
    invoke-direct {p0, p1}, Lpdc;-><init>(Lpdc;)V
...
.method public final u0(ILvdc;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Ll0f;->R(I)V

    :cond_0
    invoke-virtual {p2, v0}, Lvdc;->g(Landroid/view/View;)V
...
.method public final v(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Ll0f;->y(I)Landroid/view/View;
...
.method public abstract x0(ILvdc;Lzdc;)I
.end method

.method public y(Lvdc;Lzdc;)I
    .locals 0
...
.method public abstract z0(ILvdc;Lzdc;)I
.end method
