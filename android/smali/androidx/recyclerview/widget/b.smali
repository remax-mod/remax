...
.method public attachForPoolingContainer(Lhdc;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public clear()V
    ...
    iget-object v2, v1, Ludc;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v1, Ludc;->a:Ljava/util/ArrayList;
...
.method public detachForPoolingContainer(Lhdc;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Ludc;->a:Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lr5b;->a(Landroid/view/View;)V
...
.method public factorInBindTime(IJ)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/b;->getScrapDataForType(I)Ludc;

    move-result-object p1

    iget-wide v0, p1, Ludc;->d:J

    invoke-virtual {p0, v0, v1, p2, p3}, Landroidx/recyclerview/widget/b;->runningAverage(JJ)J

    move-result-wide p2

    iput-wide p2, p1, Ludc;->d:J
...
.method public factorInCreateTime(IJ)V
    ...
    iget-wide v0, p1, Ludc;->c:J

    invoke-virtual {p0, v0, v1, p2, p3}, Landroidx/recyclerview/widget/b;->runningAverage(JJ)J

    move-result-wide p2

    iput-wide p2, p1, Ludc;->c:J

    return-void
.end method

.method public getRecycledView(I)Ldec;
    .locals 1
    ...
    iget-object p0, p0, Ludc;->a:Ljava/util/ArrayList;
...
.method public final getScrapDataForType(I)Ludc;
    .locals 1
...
.method public onAdapterChanged(Lhdc;Lhdc;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public putRecycledView(Ldec;)V
    .locals 2

    iget v0, p1, Ldec;->Y:I

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/b;->getScrapDataForType(I)Ludc;
    ...
    invoke-static {p0}, Lr5b;->a(Landroid/view/View;)V
...
.method public size()I
    ...
    iget-object v2, v2, Ludc;->a:Ljava/util/ArrayList;
