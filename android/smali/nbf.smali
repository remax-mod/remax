...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnbf;->p:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnbf;->c:Landroid/graphics/Matrix;
    ...
    .line 8
    iput-object v0, p0, Lnbf;->m:Ljava/lang/String;

    .line 9
    iput-object v0, p0, Lnbf;->n:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lnbf;->a:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lnbf;->b:Landroid/graphics/Path;
...
.method public constructor <init>(Lnbf;)V
    ...
    iget-object v2, p1, Lnbf;->g:Lkbf;

    invoke-direct {v1, v2, v0}, Lkbf;-><init>(Lkbf;Lus;)V

    iput-object v1, p0, Lnbf;->g:Lkbf;

    .line 29
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lnbf;->a:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lnbf;->a:Landroid/graphics/Path;

    .line 30
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lnbf;->b:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lnbf;->b:Landroid/graphics/Path;
    ...
    .line 36
    iget-object v1, p1, Lnbf;->m:Ljava/lang/String;

    iput-object v1, p0, Lnbf;->m:Ljava/lang/String;
    ...
    .line 39
    :cond_0
    iget-object p1, p1, Lnbf;->n:Ljava/lang/Boolean;

    iput-object p1, p0, Lnbf;->n:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Lkbf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 18
    ...
    iget-object v0, v7, Lkbf;->a:Landroid/graphics/Matrix;

    move-object/from16 v1, p2

    invoke-virtual {v0, v1}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v10, v7, Lkbf;->a:Landroid/graphics/Matrix;

    iget-object v0, v7, Lkbf;->j:Landroid/graphics/Matrix;
    ...
    :goto_0
    iget-object v0, v7, Lkbf;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v0 .. v5}, Lnbf;->a(Lkbf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v13, v6, Lnbf;->c:Landroid/graphics/Matrix;
    ...
    iget-object v3, v6, Lnbf;->a:Landroid/graphics/Path;

    invoke-virtual {v3}, Landroid/graphics/Path;->reset()V

    iget-object v4, v0, Lmbf;->a:[Lsra;

    if-eqz v4, :cond_3

    invoke-static {v4, v3}, Lm6d;->A([Lsra;Landroid/graphics/Path;)V

    :cond_3
    iget-object v4, v6, Lnbf;->b:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    instance-of v5, v0, Libf;
    ...
    iget v14, v0, Ljbf;->k:F

    add-float/2addr v14, v9

    rem-float/2addr v14, v10

    iget-object v9, v6, Lnbf;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v9, v6, Lnbf;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v10, v6, Lnbf;->f:Landroid/graphics/PathMeasure;

    const/4 v15, 0x1

    invoke-virtual {v10, v5, v9, v3, v15}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v5, v6, Lnbf;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v3, v0, Ljbf;->g:Ljn;

    iget-object v5, v3, Ljn;->c:Ljava/lang/Object;
    ...
    iget-object v5, v6, Lnbf;->e:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Lnbf;->e:Landroid/graphics/Paint;
    ...
    iget-object v11, v3, Ljn;->c:Ljava/lang/Object;
    ...
    iget v11, v0, Ljbf;->i:F

    sget-object v16, Lqbf;->u0:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_9
    iget-object v5, v6, Lnbf;->d:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Lnbf;->d:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Ljbf;->n:Landroid/graphics/Paint$Join;
    ...
    :cond_12
    iget-object v11, v0, Ljbf;->m:Landroid/graphics/Paint$Cap;
    ...
    iget v11, v0, Ljbf;->h:F

    sget-object v13, Lqbf;->u0:Landroid/graphics/PorterDuff$Mode;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Lnbf;->setRootAlpha(I)V
