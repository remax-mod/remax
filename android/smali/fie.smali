...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfie;->X:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Ls7g;)V
    ...
    invoke-direct {v1, p1}, Leie;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lfie;->a:Landroid/content/Context;

    iput-object p2, p0, Lfie;->c:Ls7g;

    iput-object v0, p0, Lfie;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lfie;->o:Leie;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lfie;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, La14;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v3, p1}, La14;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Ll7g;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Ll7g;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final d(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lfie;->a:Landroid/content/Context;

    iget-object v1, p0, Lfie;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lfie;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lfie;->f(Landroid/app/job/JobInfo;)Ll7g;
    ...
    invoke-static {v1, v2}, Lfie;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, Lfie;->c:Ls7g;

    iget-object p0, p0, Ls7g;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->v()Ldie;
...
.method public final varargs e([Lh8g;)V
    ...
    iget-object v7, v5, Lh8g;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Li8g;->l(Ljava/lang/String;)Lh8g;
    ...
    sget-object v8, Lfie;->X:Ljava/lang/String;

    iget-object v9, v5, Lh8g;->a:Ljava/lang/String;
    ...
    invoke-virtual {v5, v8, v6}, La14;->R(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v6, v6, Lh8g;->b:Lm7g;

    sget-object v10, Lm7g;->a:Lm7g;
    ...
    :cond_1
    invoke-static {v5}, Lju0;->n(Lh8g;)Ll7g;
    ...
    invoke-virtual {v7, v6}, Ldie;->x(Ll7g;)Lcie;
    ...
    invoke-direct {v9, v2, v8}, Lft6;-><init>(Lre6;I)V

    iget-object v8, v2, Lre6;->b:Ljava/lang/Object;

    check-cast v8, Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v8, v9}, Lilc;->p(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Ll7g;->a:Ljava/lang/String;

    iget v6, v6, Ll7g;->b:I

    invoke-direct {v7, v9, v6, v8}, Lcie;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Ls7g;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->v()Ldie;

    move-result-object v6

    invoke-virtual {v6, v7}, Ldie;->A(Lcie;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lfie;->g(Lh8g;I)V
...
.method public final g(Lh8g;I)V
    .locals 11

    iget-object v0, p0, Lfie;->b:Landroid/app/job/JobScheduler;

    iget-object v1, p0, Lfie;->o:Leie;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, p1, Lh8g;->j:Lkj3;
    ...
    iget-object v5, p1, Lh8g;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Ley8;->t(I)Ljava/lang/String;
    ...
    sget-object v9, Leie;->b:Ljava/lang/String;

    invoke-virtual {v3, v9, v8}, La14;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    :goto_3
    iget-object v3, v2, Lkj3;->h:Ljava/util/Set;
    ...
    iget-boolean v9, v4, Ljj3;->b:Z

    new-instance v10, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v4, v4, Ljj3;->a:Landroid/net/Uri;
    ...
    invoke-static {v1}, Ljd8;->n(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v1, v4, v2}, La14;->R(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v1, p1, Lh8g;->q:Z

    if-eqz v1, :cond_d

    iget-object v1, p1, Lh8g;->r:Ljna;

    sget-object v2, Ljna;->a:Ljna;

    if-ne v1, v2, :cond_d

    iput-boolean v7, p1, Lh8g;->q:Z
    ...
    invoke-virtual {v2, v4, v1}, La14;->n(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Lfie;->g(Lh8g;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v4, p1, p0}, La14;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_9
    iget-object p2, p0, Lfie;->a:Landroid/content/Context;

    invoke-static {p2, v0}, Lfie;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Li8g;->i()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v4, p2}, La14;->q(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    invoke-direct {v0, p2, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Ls7g;->b:Lme3;
