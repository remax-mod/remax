...
# direct methods
.method public constructor <init>(Llue;JJ)V
    .locals 7
    ...
    invoke-virtual {p1, v1, v0, v3, v4}, Llue;->n(ILjue;J)Ljue;
    ...
    :cond_5
    :goto_2
    iput-wide p2, p0, Lb43;->c:J

    iput-wide p4, p0, Lb43;->o:J
    ...
    :goto_3
    iput-wide p2, p0, Lb43;->X:J

    iget-boolean p1, p1, Ljue;->t0:Z
...
.method public final g(ILgue;Z)Lgue;
    ...
    iget-object v1, p0, Lr06;->b:Llue;

    const/4 v2, 0x0

    invoke-virtual {v1, v2, p2, p3}, Llue;->g(ILgue;Z)Lgue;

    iget-wide v1, p2, Lgue;->X:J

    iget-wide v3, p0, Lb43;->c:J

    sub-long v6, v1, v3

    iget-wide v0, p0, Lb43;->X:J
    ...
    :goto_0
    iget-object v1, p2, Lgue;->a:Ljava/lang/Object;

    iget-object v2, p2, Lgue;->b:Ljava/lang/Object;
...
.method public final n(ILjue;J)Ljue;
    ...
    iget-wide p3, p2, Ljue;->B0:J

    iget-wide v0, p0, Lb43;->c:J

    add-long/2addr p3, v0

    iput-wide p3, p2, Ljue;->B0:J

    iget-wide p3, p0, Lb43;->X:J

    iput-wide p3, p2, Ljue;->y0:J

    iget-boolean p1, p0, Lb43;->Y:Z

    iput-boolean p1, p2, Ljue;->t0:Z

    iget-wide p3, p2, Ljue;->x0:J
    ...
    iput-wide p3, p2, Ljue;->x0:J

    iget-wide p0, p0, Lb43;->o:J
    ...
    iput-wide p3, p2, Ljue;->X:J

    :cond_2
    iget-wide p3, p2, Ljue;->Y:J
