...
.field private final create:Lm56;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lm56;"
        }
...
.method public constructor <init>(ILm56;)V
    ...
    iput-object p2, p0, Lkotlinx/coroutines/internal/OnDemandAllocatingPool;->create:Lm56;
...
.method private final synthetic loop$atomicfu(Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;Lm56;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final allocate()Z
    ...
    iget-object p0, p0, Lkotlinx/coroutines/internal/OnDemandAllocatingPool;->create:Lm56;
...
.method public final close()Ljava/util/List;
    ...
    :goto_0
    invoke-static {v4, v1}, Lote;->Y(II)Lj37;
