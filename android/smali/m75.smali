...
# direct methods
.method public static a(Landroid/content/Context;Lu75;ZLjava/lang/String;)Lj4b;
    .locals 2
    ...
    invoke-static {v0}, Lxs3;->g(Ljava/lang/Object;)Landroid/media/metrics/MediaMetricsManager;
    ...
    invoke-static {v0}, Lid8;->l(Landroid/media/metrics/MediaMetricsManager;)Landroid/media/metrics/PlaybackSession;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lkd8;-><init>(Landroid/content/Context;Landroid/media/metrics/PlaybackSession;)V
    ...
    invoke-static {p0}, Lid8;->a(Landroid/media/metrics/PlaybackSession;)Landroid/media/metrics/LogSessionId;
