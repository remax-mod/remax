...
# direct methods
.method public constructor <init>(Lbj8;Lld8;Lsh0;)V
    .locals 1
    ...
    invoke-direct {p2, p1}, Lpv9;-><init>(Landroid/content/Context;)V

    .line 34
    iput-object p2, p0, Lue;->f:Ljava/lang/Object;
    ...
    invoke-direct {p3, p2, v0}, La84;-><init>(Landroid/os/Handler;I)V

    iput-object p3, p0, Lue;->g:Ljava/lang/Object;
    ...
    iput-object p2, p0, Lue;->h:Ljava/lang/Cloneable;
    ...
    iput-object p1, p0, Lue;->i:Ljava/lang/Object;

    const/4 p1, 0x0

    .line 39
    iput-boolean p1, p0, Lue;->b:Z

    return-void
.end method

.method public constructor <init>(Loz7;La8g;Landroid/graphics/Rect;Z)V
    .locals 5
    ...
    .line 6
    iget-object p2, p2, La8g;->a:Ljava/lang/Object;

    check-cast p2, Lcom/facebook/animated/gif/GifImage;

    .line 7
    iput-object p2, p0, Lue;->e:Ljava/lang/Object;
    ...
    iput-object p2, p0, Lue;->g:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lue;->g:Ljava/lang/Object;
    ...
    .line 22
    :cond_3
    iget-object p1, p0, Lue;->e:Ljava/lang/Object;

    check-cast p1, Lcom/facebook/animated/gif/GifImage;

    invoke-static {p1, p3}, Lue;->a(Lcom/facebook/animated/gif/GifImage;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lue;->h:Ljava/lang/Cloneable;
    ...
    .line 26
    iget-object p1, p0, Lue;->h:Ljava/lang/Cloneable;

    check-cast p1, [Lve;

    iget-object p2, p0, Lue;->e:Ljava/lang/Object;

    check-cast p2, Lcom/facebook/animated/gif/GifImage;

    invoke-virtual {p2, v0}, Lcom/facebook/animated/gif/GifImage;->g(I)Lve;
...
# virtual methods
.method public b(Lqh8;)La98;
    .locals 0

    iget-object p0, p0, Lue;->i:Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lfm9;->C(Ljava/util/concurrent/Future;)Ljava/lang/Object;
...
.method public c(Landroid/graphics/Canvas;FFLve;)V
    .locals 4
...
.method public d(Z)V
    ...
    iget-object v1, v0, Lbj8;->a:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lbj8;->c:Lus;

    invoke-virtual {v0}, Lus;->values()Ljava/util/Collection;
    ...
    invoke-virtual {p0, v3, v0}, Lue;->i(Lqh8;Z)Z
    ...
    invoke-static {v2, p1}, Lod8;->a(Lbj8;Z)V
    ...
    iget-object p1, p0, Lue;->j:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lue;->j:Ljava/lang/Object;
...
.method public declared-synchronized e(II)Landroid/graphics/Bitmap;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lue;->j:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lue;->j:Ljava/lang/Object;
    :try_end_1
    ...
    iput-object p1, p0, Lue;->j:Ljava/lang/Object;
...
.method public f(Landroid/graphics/Canvas;I)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lue;->g(Landroid/graphics/Canvas;Lcom/facebook/animated/gif/GifFrame;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public g(Landroid/graphics/Canvas;Lcom/facebook/animated/gif/GifFrame;)V
    .locals 5
    ...
    :try_start_0
    invoke-virtual {p0, v1, v2}, Lue;->e(II)Landroid/graphics/Bitmap;

    move-result-object v4

    iput-object v4, p0, Lue;->j:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lue;->j:Ljava/lang/Object;
...
.method public h(Landroid/graphics/Canvas;Lcom/facebook/animated/gif/GifFrame;Lve;Lve;)V
    .locals 6

    iget-object p3, p0, Lue;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p3, p3, p4}, Lue;->c(Landroid/graphics/Canvas;FFLve;)V
    ...
    :try_start_0
    invoke-virtual {p0, p4, v0}, Lue;->e(II)Landroid/graphics/Bitmap;
...
.method public i(Lqh8;Z)Z
    .locals 0

    invoke-virtual {p0, p1}, Lue;->b(Lqh8;)La98;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0}, La98;->u()Z
...
.method public j(Lqh8;Lsh0;Z)V
    ...
    iget-object v2, p2, Lsh0;->c:Ljava/lang/Object;
    ...
    :cond_0
    iput-object p2, p0, Lue;->j:Ljava/lang/Object;

    iget p1, p2, Lsh0;->b:I

    if-eqz p3, :cond_2

    iget-object p2, p0, Lue;->h:Ljava/lang/Cloneable;

    check-cast p2, Landroid/content/Intent;

    iget-object p3, p0, Lue;->c:Ljava/lang/Object;

    check-cast p3, Lbj8;

    invoke-static {p3, p2}, Lnt3;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    invoke-static {p3, p1, v2, p2, v0}, Llaf;->a(Landroid/app/Service;ILandroid/app/Notification;ILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p3, p1, v2}, Landroid/app/Service;->startForeground(ILandroid/app/Notification;)V
    ...
    invoke-virtual {p3, p2, p1, v2}, Lpv9;->a(Ljava/lang/String;ILandroid/app/Notification;)V

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lue;->d(Z)V
