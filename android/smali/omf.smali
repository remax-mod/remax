...
.method public static b(Landroid/view/View;Lx6g;Landroid/graphics/Rect;)Lx6g;
    .locals 1
...
.method public static j(Landroid/view/View;)Lx6g;
    .locals 7

    sget-boolean v0, Ll6g;->d:Z
    ...
    :try_start_0
    sget-object v2, Ll6g;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Ll6g;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Ll6g;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, Lv27;->b(IIII)Lv27;

    move-result-object v2

    invoke-virtual {v3, v2}, Lm6g;->i(Lv27;)V
    ...
    invoke-static {v2, v4, v5, v0}, Lv27;->b(IIII)Lv27;

    move-result-object v0

    invoke-virtual {v3, v0}, Lm6g;->f(Lv27;)V

    invoke-virtual {v3}, Lm6g;->b()Lx6g;

    move-result-object v0

    iget-object v2, v0, Lx6g;->a:Lv6g;

    invoke-virtual {v2, v0}, Lv6g;->q(Lx6g;)V
    ...
    invoke-virtual {v2, p0}, Lv6g;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Ly2a;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lnmf;-><init>(Landroid/view/View;Ly2a;)V
