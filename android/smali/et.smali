...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Let;->a:Landroid/os/SharedMemory;

    invoke-virtual {p1}, Landroid/os/SharedMemory;->mapReadWrite()Ljava/nio/ByteBuffer;

    move-result-object p1

    iput-object p1, p0, Let;->b:Ljava/nio/ByteBuffer;
    :try_end_0
...
.method public final declared-synchronized S(III[B)I
    ...
    iget-object v0, p0, Let;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p0}, Let;->getSize()I

    move-result v0

    invoke-static {p1, p3, v0}, Lema;->a(III)I
    ...
    invoke-static {p1, v0, p2, p3, v1}, Lema;->i(IIIII)V

    iget-object v0, p0, Let;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v0, p1}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget-object p1, p0, Let;->b:Ljava/nio/ByteBuffer;
...
.method public final a(Loq8;I)V
    .locals 3
    ...
    invoke-virtual {p0}, Let;->isClosed()Z
    ...
    invoke-virtual {p1}, Let;->isClosed()Z
    ...
    iget-object v0, p1, Let;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1}, Let;->getSize()I
    ...
    invoke-static {v2, v0, v2, p2, v1}, Lema;->i(IIIII)V
    ...
    iget-object p0, p0, Let;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {p0, v0, v2, p2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object p0, p1, Let;->b:Ljava/nio/ByteBuffer;
...
.method public final declared-synchronized close()V
    ...
    iget-object v0, p0, Let;->a:Landroid/os/SharedMemory;
    ...
    iput-object v0, p0, Let;->b:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Let;->a:Landroid/os/SharedMemory;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final getSize()I
    ...
    iget-object p0, p0, Let;->a:Landroid/os/SharedMemory;
...
.method public final n(Loq8;I)V
    .locals 4

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Loq8;->m()J

    move-result-wide v0

    iget-wide v2, p0, Let;->c:J
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2}, Let;->a(Loq8;I)V
