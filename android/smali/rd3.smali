...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    :cond_0
    sget-object p0, Ljj6;->c:Landroid/content/Context;
    ...
    :cond_1
    sget-object p1, Ljj6;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_1
    iget-object p1, p1, Lqi8;->c:Ljava/lang/Object;
    ...
    :catch_0
    invoke-static {p0}, Ljj6;->a(Ljava/io/File;)V
    ...
    invoke-static {v1, p1}, Llk5;->J(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    const-string p2, "dump-meta.json"

    invoke-static {v1, p2}, Llk5;->J(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1}, Lm6d;->k(Ljava/io/File;)V
    ...
    invoke-static {p2}, Lm6d;->k(Ljava/io/File;)V

    :cond_6
    invoke-static {p0, p1}, Lm6d;->K(Ljava/io/File;Ljava/io/File;)V

    invoke-static {v0, p2}, Lm6d;->K(Ljava/io/File;Ljava/io/File;)V
    :try_end_1
    ...
    :catch_1
    invoke-static {p1}, Ljj6;->a(Ljava/io/File;)V

    invoke-static {p2}, Ljj6;->a(Ljava/io/File;)V
