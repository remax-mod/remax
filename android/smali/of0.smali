...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p3}, Lp5f;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object p2, p0, Lof0;->e:Ljava/io/File;

    const-string p1, "^lib/([^/]+)/([^/]+\\.so)$"

    iput-object p1, p0, Lof0;->f:Ljava/lang/String;
...
.method public final e()[B
    ...
    iget-object v0, p0, Lp5f;->d:Landroid/content/Context;

    iget-object v1, p0, Lof0;->e:Ljava/io/File;
...
.method public final g(Z)Lcom/facebook/soloader/e;
    ...
    invoke-direct {v0, p0, p0, p1}, Lcom/facebook/soloader/a;-><init>(Lof0;Lof0;Z)V
