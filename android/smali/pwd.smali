...
.field public final s0:Ljava/util/concurrent/atomic/AtomicLong;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpwd;->u0:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lpwd;->a:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v1, p0, Lpwd;->s0:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v2, p0, Lpwd;->X:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    iput-object v2, p0, Lpwd;->Z:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final isEmpty()Z
    ...
    iget-object v0, p0, Lpwd;->a:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v0

    iget-object p0, p0, Lpwd;->s0:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public final offer(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lpwd;->X:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lpwd;->a:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v13, p0, Lpwd;->X:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    add-long/2addr v2, v5

    sub-long/2addr v2, v7

    iput-wide v2, p0, Lpwd;->c:J
    ...
    sget-object p0, Lpwd;->u0:Ljava/lang/Object;
...
.method public final poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lpwd;->Z:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lpwd;->s0:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v7, Lpwd;->u0:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lpwd;->Z:Ljava/util/concurrent/atomic/AtomicReferenceArray;
